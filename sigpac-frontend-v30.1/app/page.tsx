                    ...
                    <div style={{ padding: '10px 12px', borderRadius: 8, background: 'rgba(255,180,84,0.08)', border: '1px solid rgba(255,180,84,0.3)' }}>
                      {!cultivoAnteriorGuardado ? (
                        <>
                          ...
                          <button onClick={guardarCultivoAnterior} style={{ padding: '7px 12px', borderRadius: 6, background: 'transparent', border: '1px solid #ffb454', color: '#ffb454', fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 700, cursor: 'pointer' }}>
