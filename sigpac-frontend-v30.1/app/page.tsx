  ...
  const guardarComercializacion = async () => {
    ...
    if (comEditarId) {
      ...
      const nueva: Comercializacion = {
        ...
        comprador: comComprador.trim() || undefined, compradorDniNif: comCompradorDniNif.trim() || undefined, observaciones: comObservaciones.trim() || undefined,
    ...
    if (comFormParteKey) {
      ...
      const nuevas: Comercializacion[] = reparto.map((r, i) => ({
        id: `${Date.now()}-${i}`, cosechaId: r.cosechaId, fecha: comFecha, cantidad: String(r.cantidad), unidad: comUnidad,
        comprador: comComprador.trim() || undefined, compradorDniNif: comCompradorDniNif.trim() || undefined, observaciones: comObservaciones.trim() || undefined, fechaRegistro,
      }))
