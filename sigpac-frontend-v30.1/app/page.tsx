...
export default function Home() {
  ...
  const aplicarResultadoROPO = (registro: any) => {
    ...
    // con telefono/email) -> lo volcamos en Telefono como mejor opcion disponible,
    // el usuario puede corregirlo a mano si no encaja.
                ...
                <div style={{ padding: '10px 12px', borderRadius: 6, background: 'var(--surface2)', border: '1px solid var(--border)', fontSize: 12, fontFamily: 'var(--mono)', color: 'var(--text)' }}>
                  {verifResultado.encontrados === 0 ? (
                    ...
                    <div>
                      ...
                      {verifResultado.registros.length < verifResultado.encontrados && (
                        <div style={{ marginBottom: 8, color: '#fbbf24', fontSize: 11 }}>
                          ⚠ Solo se muestran las primeras {verifResultado.registros.length} (paginación aún no soportada)
                        </div>
                      )}
