                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                    ...
                    {misPermisos['parcelas.ubicaciones.gestionar'] && (
                      <button onClick={iniciarNuevaUbicacion} disabled={fincas.length === 0}
                        style={{ padding: '5px 12px', borderRadius: 6, background: fincas.length === 0 ? 'var(--surface2)' : 'rgba(77,184,255,0.1)', border: `1px solid ${fincas.length === 0 ? 'var(--border)' : 'rgba(77,184,255,0.35)'}`, color: fincas.length === 0 ? 'var(--muted)' : 'var(--blue)', fontFamily: 'var(--mono)', fontSize: 11, cursor: fincas.length === 0 ? 'default' : 'pointer', fontWeight: 700 }}>
                        + Añadir ubicación
                      </button>
                    )}
                  </div>
                        ...
                        <div key={u.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, padding: '7px 10px', background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 6 }}>
                          ...
                          {misPermisos['parcelas.ubicaciones.gestionar'] && (
                            <div style={{ display: 'flex', gap: 8, flexShrink: 0 }}>
                              <button onClick={() => editarUbicacion(u)} style={{ fontSize: 11, color: 'var(--muted)', background: 'transparent', border: 'none', cursor: 'pointer' }}>✏</button>
                              <button onClick={() => eliminarUbicacion(u.id)} style={{ fontSize: 11, color: '#fca5a5', background: 'transparent', border: 'none', cursor: 'pointer' }}>✕</button>
                            </div>
                          )}
                        </div>
                      ))}
                  ...
                  <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, width: '100%', maxWidth: 400, padding: 24 }}>
                    ...
                    <div style={{ marginBottom: 16 }}>
                      ...
                      <select value={ubicacionFincaId} onChange={e => { setUbicacionFincaId(e.target.value); setUbicacionParcelaIds([]) }}
                        style={{ width: '100%', background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 6, padding: '9px 12px', color: ubicacionFincaId ? 'var(--text)' : 'var(--muted)', fontSize: 13, fontFamily: 'var(--sans)', outline: 'none' }}>
                    ...
                    <div style={{ display: 'flex', gap: 10 }}>
                      ...
                      <button onClick={cerrarFormUbicacion} style={{ flex: 1, padding: 11, borderRadius: 8, background: 'var(--surface2)', border: '1px solid var(--border)', color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: 13, cursor: 'pointer' }}>CANCELAR</button>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div style={{ position: 'fixed', inset: 0, background: 'var(--bg)', zIndex: 2000 }}>
                  <div style={{ position: 'absolute', top: 12, left: 12, right: 12, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap' }}>
                    <button onClick={() => setFormUbicacionPaso('finca')}
                      style={{ padding: '8px 14px', borderRadius: 8, background: 'rgba(15,26,18,0.92)', border: '1px solid var(--border)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 12, cursor: 'pointer', fontWeight: 700 }}>
                      ← Atrás
                    </button>
                  ...
                  <div style={{ position: 'absolute', bottom: 20, left: '50%', transform: 'translateX(-50%)', zIndex: 1000 }}>
                    <button onClick={confirmarPuntoUbicacion} disabled={!ubicacionPunto}
                      style={{ padding: '12px 28px', borderRadius: 10, background: ubicacionPunto ? 'var(--green)' : 'var(--surface2)', border: 'none', color: ubicacionPunto ? 'var(--bg)' : 'var(--muted)', fontFamily: 'var(--mono)', fontWeight: 700, fontSize: 13, cursor: ubicacionPunto ? 'pointer' : 'default', letterSpacing: '0.06em' }}>
                    ...
                    <div style={{ marginBottom: 16 }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                        ...
                        <button onClick={() => setUbicacionParcelaIds(misParcelas.filter(p => p.fincaId === ubicacionFincaId).map(p => p.id))}
                          style={{ fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--blue)', background: 'transparent', border: 'none', cursor: 'pointer' }}>
                          Seleccionar todas
                        </button>
                      </div>
                    ...
                    <div style={{ marginBottom: 16 }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                        ...
                        {misPermisos['cosechas.crear_editar_eliminar'] && (
                          <button onClick={() => abrirNuevaCosecha(parcelaDetalle)} style={{ padding: '5px 10px', borderRadius: 6, background: 'transparent', border: '1px solid var(--green)', color: 'var(--green)', fontFamily: 'var(--mono)', fontSize: 10, fontWeight: 700, cursor: 'pointer' }}>+ NUEVA COSECHA</button>
                        )}
                      </div>
                                  ...
                                  {expandida && (
                                    <div style={{ padding: '0 10px 10px', borderTop: '1px solid var(--border)' }}>
                                      ...
                                      <div style={{ display: 'flex', gap: 6, marginBottom: 8 }}>
                                        {misPermisos['cosechas.crear_editar_eliminar'] && (
                                          <button onClick={() => abrirEditarCosecha(c)} style={{ padding: '5px 10px', borderRadius: 5, background: 'transparent', border: '1px solid var(--border)', color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer' }}>Editar</button>
                                        )}
                                        {misPermisos['cosechas.crear_editar_eliminar'] && (
                                          <button onClick={() => eliminarCosecha(c.id)} style={{ padding: '5px 10px', borderRadius: 5, background: 'transparent', border: '1px solid #fca5a5', color: '#fca5a5', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer' }}>Eliminar</button>
                                        )}
                                      </div>
                                          ...
                                          <div key={com.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 5, padding: '6px 8px', fontSize: 10, fontFamily: 'var(--mono)' }}>
                                            ...
                                            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                                              {misPermisos['cosechas.comercializacion.crear_editar_eliminar'] && (
                                                <button onClick={() => abrirEditarComercializacion(com)} style={{ background: 'transparent', border: 'none', color: 'var(--muted)', cursor: 'pointer', fontSize: 10 }} title="Editar">✏</button>
                                              )}
                                              {misPermisos['cosechas.comercializacion.crear_editar_eliminar'] && (
                                                <button onClick={() => eliminarComercializacion(com.id)} style={{ background: 'transparent', border: 'none', color: '#fca5a5', cursor: 'pointer', fontSize: 10 }} title="Eliminar">✕</button>
                                              )}
                                            </div>
                                          </div>
                                        ))}
                                      ...
                                      {comFormCosechaId === c.id && misPermisos['cosechas.comercializacion.crear_editar_eliminar'] ? (
                                        <div style={{ background: 'var(--surface)', border: '1px solid var(--blue)', borderRadius: 6, padding: 8, display: 'flex', flexDirection: 'column', gap: 6 }}>
                                          ...
                                          <div style={{ display: 'flex', gap: 6 }}>
                                            ...
                                            <button onClick={() => { setComFormCosechaId(null); setComFormParteKey(null); setComEditarId(null) }} style={{ padding: '6px 10px', borderRadius: 5, background: 'transparent', border: '1px solid var(--border)', color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer' }}>Cancelar</button>
                                          </div>
                                        </div>
                                      ) : misPermisos['cosechas.comercializacion.crear_editar_eliminar'] ? (
                                        <button onClick={() => abrirNuevaComercializacion(c.id)} style={{ padding: '6px 10px', borderRadius: 5, background: 'transparent', border: '1px solid var(--blue)', color: 'var(--blue)', fontFamily: 'var(--mono)', fontSize: 10, fontWeight: 700, cursor: 'pointer' }}>+ Comercialización</button>
                                      ) : null}
                                      </>)}
                                    </div>
                                  )}
                      ...
                      {tarTipo === 'Alternativa no química' && (
                        <div style={{ padding: '10px 12px', borderRadius: 8, background: 'var(--surface2)', border: '1px solid var(--border)', display: 'flex', flexDirection: 'column', gap: 10 }}>
                          ...
                          <div>
                            ...
                            <select value={tarEficacia} onChange={e => setTarEficacia(e.target.value as any)} style={{ width: '100%', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 6, padding: '9px 12px', color: tarEficacia ? 'var(--text)' : 'var(--muted)', fontSize: 13, fontFamily: 'var(--sans)', outline: 'none' }}>
          ...
          return (
            <div key="cosechas" style={{ flex: 1, height: '100%', overflow: 'auto', padding: isMobile ? 12 : 24, background: 'var(--bg)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10, marginBottom: 16 }}>
                ...
                {misPermisos['cosechas.crear_editar_eliminar'] && (
                  <button onClick={() => abrirNuevaCosecha()} style={{ padding: '7px 14px', borderRadius: 6, background: 'rgba(61,220,110,0.1)', border: '1px solid var(--green)', color: 'var(--green)', fontFamily: 'var(--mono)', fontSize: 12, fontWeight: 700, cursor: 'pointer' }}>+ NUEVA COSECHA</button>
                )}
              </div>
                        ...
                        {expandida && (
                          <div style={{ padding: '0 14px 14px', borderTop: '1px solid var(--border)' }}>
                                ...
                                return (
                                  <div key={e.id} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 5, padding: '6px 8px', fontSize: 10, fontFamily: 'var(--mono)', gap: 8 }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0 }}>
                                      {misPermisos['cosechas.crear_editar_eliminar'] && (
                                        <button onClick={() => abrirEditarCosecha(e)} style={{ background: 'transparent', border: 'none', color: 'var(--muted)', cursor: 'pointer', fontSize: 10 }} title="Editar">✏</button>
                                      )}
                                      {misPermisos['cosechas.crear_editar_eliminar'] && (
                                        <button onClick={() => eliminarCosecha(e.id)} style={{ background: 'transparent', border: 'none', color: '#fca5a5', cursor: 'pointer', fontSize: 10 }} title="Eliminar">✕</button>
                                      )}
                                    </div>
                                  </div>
                                )
                            ...
                            {formAqui && misPermisos['cosechas.comercializacion.crear_editar_eliminar'] ? (
                              ...
                              <button onClick={() => abrirNuevaComercializacionParte(parte.key)} style={{ padding: '6px 10px', borderRadius: 5, background: 'transparent', border: '1px solid var(--blue)', color: 'var(--blue)', fontFamily: 'var(--mono)', fontSize: 10, fontWeight: 700, cursor: 'pointer' }}>+ Comercialización</button>
                            ) : null}
                            </>)}
                          </div>
                        )}
            ...
            <div style={{ background: 'var(--surface)', border: '1px solid var(--green)', borderRadius: 12, width: '100%', maxWidth: 420, padding: 24, maxHeight: '90vh', overflowY: 'auto' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
                  ...
                  <button onClick={() => { setCosFormVisible(false); setCosEditar(null) }} style={{ flex: 1, padding: 11, borderRadius: 8, background: 'var(--surface2)', border: '1px solid var(--border)', color: 'var(--muted)', fontFamily: 'var(--mono)', fontSize: 13, cursor: 'pointer' }}>CANCELAR</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div style={{ background: 'var(--surface)', border: '1px solid var(--green)', borderRadius: 12, width: '100%', maxWidth: 460, maxHeight: '90vh', overflow: 'auto' }}>
            ...
            <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <button onClick={() => abrirFormDatosExplotacion(cuadernoFincaIds)} disabled={cuadernoFincaIds.length === 0}
                style={{ fontSize: 11, fontFamily: 'var(--mono)', color: cuadernoFincaIds.length === 0 ? 'var(--muted)' : 'var(--blue)', background: 'transparent', border: 'none', cursor: cuadernoFincaIds.length === 0 ? 'default' : 'pointer', textDecoration: cuadernoFincaIds.length === 0 ? 'none' : 'underline', alignSelf: 'flex-start', padding: 0 }}>
