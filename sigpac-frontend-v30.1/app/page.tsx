                    ...
                    {contornosStats && (
                      <div style={{ marginTop: 10 }}>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 5 }}>
                          {[{ k: 'Alt. mín', v: `${contornosStats.altitud_min}m` }, { k: 'Alt. máx', v: `${contornosStats.altitud_max}m` }, { k: 'Alt. media', v: `${contornosStats.altitud_media}m` }, { k: 'Intervalo', v: `${contornosStats.intervalo_m}m` }].map(s => (
