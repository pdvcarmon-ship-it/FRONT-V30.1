                ...
                <div style={{ position: 'absolute', top: '100%', left: 0, zIndex: 6000, background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '0 0 10px 10px', boxShadow: '0 8px 24px rgba(0,0,0,0.5)', minWidth: 220 }}>
                  {(['mapa', 'mis_parcelas', 'tratamientos', 'tareas', 'riego', 'cosechas', 'personal', 'equipos', 'permisos'] as Pestaña[]).filter(tab => puedeVerPestana(tab, misPermisos)).map(tab => (
                    <button key={tab} onClick={() => { setPestana(tab); setMenuAbierto(false) }}
                      style={{ display: 'block', width: '100%', padding: '15px 20px', border: 'none', background: pestana === tab ? 'rgba(61, 220, 110, 1)' : 'transparent', fontFamily: 'var(--mono)', fontSize: 14, fontWeight: pestana === tab ? 700 : 400, cursor: 'pointer', color: 'var(--text)', textAlign: 'left', borderLeft: `3px solid ${pestana === tab ? 'var(--green)' : 'transparent'}`, borderBottom: '1px solid var(--border)' }}
                    >
          ...
          <div style={{ display: 'flex', width: '100%', height: '100%', position: 'relative' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: isMobile ? '0 16px 16px' : '0', flexDirection: 'column', gap: 14, display: panelAbierto || !isMobile ? 'flex' : 'none' }}>
              ...
              <section>
                ...
                <button onClick={() => { setMododibujo(m => !m); setSeleccionando(false); setAnadiendoRecinto(false) }} style={{ width: '100%', padding: '9px', borderRadius: 8, background: mododibujo ? 'rgba(77, 184, 255, 1)' : 'var(--kampo-surface-deep)', border: `1px solid ${mododibujo ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}>
                ...
                {parcelaInfo && parcelaInfo.origen !== 'dibujado_mano' && !mododibujo && (
                  <button
                    ...
                    style={{ width: '100%', marginTop: 8, padding: '9px', borderRadius: 8, background: anadiendoRecinto ? 'rgba(77, 184, 255, 1)' : 'var(--kampo-surface-deep)', border: `1px solid ${anadiendoRecinto ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}
                  >
                ...
                {parcGeojson && (
                  <div style={{ display: 'flex', gap: 6, marginTop: 6 }}>
                    <button onClick={deseleccionar} style={{ flex: 1, padding: '7px', borderRadius: 6, background: 'rgba(255, 107, 107, 1)', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, fontWeight: 700, cursor: 'pointer' }}>
                      ✕ DESELECCIONAR
                    </button>
                    <button onClick={abrirFormularioGuardar} style={{ flex: 1, padding: '7px', borderRadius: 6, background: 'rgba(61, 220, 110, 1)', border: '1px solid rgba(61, 220, 110, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, fontWeight: 700, cursor: 'pointer' }}>
                      💾 GUARDAR
                    </button>
                  </div>
                )}
              ...
              {parcGeojson && (
                <>
                  ...
                  <section>
                    ...
                    <button onClick={buscarImagenes} disabled={cargando} style={{ width: '100%', padding: '8px', borderRadius: 6, background: 'rgba(77, 184, 255, 1)', border: '1px solid var(--blue)', color: 'var(--text)', fontWeight: 700, fontSize: 11, fontFamily: 'var(--mono)', cursor: cargando ? 'wait' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                    ...
                    {productos.length > 0 && (
                      <div style={{ marginTop: 8 }}>
                        ...
                        <button onClick={verImagenRGB} disabled={cargando} style={{ width: '100%', marginTop: 8, padding: '9px', borderRadius: 6, background: modoVista === 'rgb' ? 'rgba(77, 184, 255, 1)' : 'var(--kampo-surface-deep)', border: `1px solid var(--blue)`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 700, cursor: cargando ? 'wait' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}>
              ...
              {productos.length > 0 && (
                <>
                  ...
                  <section>
                    ...
                    <button onClick={calcularZonasNDVI} disabled={cargando} style={{ width: '100%', padding: '11px', borderRadius: 8, background: cargando ? 'var(--kampo-surface-deep)' : 'rgba(77, 184, 255, 1)', border: '1px solid var(--blue)', color: 'var(--text)', fontFamily: 'var(--mono)', fontWeight: 700, fontSize: 13, cursor: cargando ? 'wait' : 'pointer', letterSpacing: '0.08em', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, transition: 'all 0.2s' }}>
              ...
              {parcGeojson && (
                <>
                  ...
                  <section>
                    ...
                    <button onClick={calcularContornos} disabled={calculandoContornos} style={{ width: '100%', padding: '10px', borderRadius: 8, background: calculandoContornos ? 'var(--kampo-surface-deep)' : 'rgba(77, 184, 255, 1)', border: '1px solid var(--blue)', color: 'var(--text)', fontFamily: 'var(--mono)', fontWeight: 700, fontSize: 12, cursor: calculandoContornos ? 'wait' : 'pointer', letterSpacing: '0.06em', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}>
                      {calculandoContornos ? <><span className="spinner" style={{ borderTopColor: 'var(--blue)' }}/> CALCULANDO MDT...</> : '🗺 GENERAR CURVAS DE NIVEL'}
                    </button>
                    <button onClick={calcularMdtColor} disabled={calculandoMdtColor} style={{ width: '100%', marginTop: 8, padding: '10px', borderRadius: 8, background: calculandoMdtColor ? 'var(--kampo-surface-deep)' : 'rgba(77, 184, 255, 1)', border: '1px solid var(--blue)', color: 'var(--text)', fontFamily: 'var(--mono)', fontWeight: 700, fontSize: 12, cursor: calculandoMdtColor ? 'wait' : 'pointer', letterSpacing: '0.06em', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}>
                    ...
                    {mapaActivo && (() => {
                      ...
                      return (
                        <div style={{ marginTop: 10 }}>
                          ...
                          <button onClick={toggleMapaMdt} style={{ width: '100%', marginTop: 8, padding: '8px', borderRadius: 6, background: mapaVisible ? 'rgba(77, 184, 255, 1)' : 'var(--kampo-surface-deep)', border: `1px solid ${mapaVisible ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer', fontWeight: 600 }}>
                        ...
                        {historico.map((entrada: any) => (
                          <div key={entrada.id} style={{ background: 'var(--kampo-surface-deep)', border: '1px solid var(--border)', borderRadius: 6, padding: '8px 10px', marginBottom: 6 }}>
                            ...
                            {entrada.geojson && (
                              ...
                              }} style={{ width: '100%', padding: '5px', borderRadius: 5, background: 'rgba(61, 220, 110, 1)', border: '1px solid rgba(61, 220, 110, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer', letterSpacing: '0.04em' }}>
                                ▶ CARGAR ANÁLISIS
                              </button>
                            )}
                          </div>
                ...
                <div>
                  ...
                  {misPermisos['fincas.crear_editar'] && (
                    <button onClick={() => { setFincaEditar(null); setFNombre(''); setFDescripcion(''); setFError(''); setFormFinca(true) }}
                      style={{ padding: '5px 12px', borderRadius: 6, background: 'rgba(61, 220, 110, 1)', border: '1px solid rgba(61, 220, 110, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer', fontWeight: 700, marginRight: 8 }}>
                      + Crear finca
                    </button>
                  )}
                  {misPermisos['parcelas.crear_editar'] && (
                    <button onClick={() => setImportarExcelVisible(true)}
                      style={{ padding: '5px 12px', borderRadius: 6, background: 'rgba(77, 184, 255, 1)', border: '1px solid rgba(77, 184, 255, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer', fontWeight: 700 }}>
                      📥 Importar Excel
                    </button>
                  )}
                  <div style={{ marginTop: 8, display: 'flex', gap: 8 }}>
                    <button onClick={() => { setCampanaEditar(null); setCampNombre(''); setCampFechaInicio(''); setCampFechaFin(''); setCampError(''); setFormCampanaVisible(true) }}
                      style={{ padding: '5px 12px', borderRadius: 6, background: 'rgba(251, 191, 36, 1)', border: '1px solid rgba(251, 191, 36, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer', fontWeight: 700 }}>
                      + Crear campaña
                    </button>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                  ...
                  {filtroFinca && (
                    <button onClick={() => verFincaEnMapa(filtroFinca)}
                      style={{ padding: '5px 12px', borderRadius: 6, background: 'rgba(255, 59, 48, 1)', border: '1px solid rgba(255, 59, 48, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer', fontWeight: 700 }}>
                      🗺 Ver finca en mapa
                    </button>
                  )}
                </div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                    ...
                    {misPermisos['parcelas.ubicaciones.gestionar'] && (
                      <button onClick={iniciarNuevaUbicacion} disabled={fincas.length === 0}
                        style={{ padding: '5px 12px', borderRadius: 6, background: fincas.length === 0 ? 'var(--surface2)' : 'rgba(77, 184, 255, 1)', border: `1px solid ${fincas.length === 0 ? 'var(--border)' : 'rgba(77, 184, 255, 1)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: fincas.length === 0 ? 'default' : 'pointer', fontWeight: 700 }}>
                        + Añadir ubicación
                      </button>
                    )}
                  </div>
              ...
              {formUbicacionPaso === 'finca' && (
                <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 2000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
                  <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, width: '100%', maxWidth: 400, padding: 24 }}>
                    ...
                    {ubicacionError && <div style={{ padding: '8px 12px', borderRadius: 6, background: 'rgba(255,107,107,0.08)', border: '1px solid rgba(255,107,107,0.2)', color: '#fca5a5', fontSize: 12, fontFamily: 'var(--mono)', marginBottom: 12 }}>{ubicacionError}</div>}
                    <div style={{ display: 'flex', gap: 10 }}>
                ...
                <div style={{ position: 'fixed', inset: 0, background: 'var(--bg)', zIndex: 2000 }}>
                  <div style={{ position: 'absolute', top: 12, left: 12, right: 12, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, flexWrap: 'wrap' }}>
                    <button onClick={() => setFormUbicacionPaso('finca')}
                      style={{ padding: '8px 14px', borderRadius: 8, background: 'rgba(15, 26, 18, 1)', border: '1px solid var(--border)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 12, cursor: 'pointer', fontWeight: 700 }}>
                      ← Atrás
                    </button>
                    <div style={{ padding: '8px 14px', borderRadius: 8, background: 'rgba(77,184,255,0.12)', border: '1px solid var(--blue)', color: 'var(--blue)', fontFamily: 'var(--mono)', fontSize: 12, fontWeight: 700 }}>
                  ...
                  <div style={{ padding: 16 }}>
                    ...
                    {historicoCultivos.filter(h => h.parcelaId === parcelaDetalle.id).length > 0 && (
                      <div style={{ marginBottom: 16 }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                          <div style={{ background: 'rgba(61,220,110,0.08)', border: '1px solid var(--green)', borderRadius: 6, padding: '8px 10px', fontSize: 11, fontFamily: 'var(--mono)' }}>
                                  ...
                                  {expandida && (
                                    <div style={{ padding: '0 10px 10px', borderTop: '1px solid var(--border)' }}>
                                      ...
                                      <div style={{ display: 'flex', gap: 6, marginBottom: 8 }}>
                                        ...
                                        {misPermisos['cosechas.crear_editar_eliminar'] && (
                                          <button onClick={() => eliminarCosecha(c.id)} style={{ padding: '5px 10px', borderRadius: 5, background: 'transparent', border: '1px solid #fca5a5', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer' }}>Eliminar</button>
                                        )}
                                      </div>
                                      ...
                                      {comFormCosechaId === c.id && misPermisos['cosechas.comercializacion.crear_editar_eliminar'] ? (
                                        <div style={{ background: 'var(--surface)', border: '1px solid var(--blue)', borderRadius: 6, padding: 8, display: 'flex', flexDirection: 'column', gap: 6 }}>
                                          ...
                                          <input value={comObservaciones} onChange={e => setComObservaciones(e.target.value)} placeholder="Observaciones (opcional)"
                                            style={{ width: '100%', background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 5, padding: '6px 8px', color: 'var(--text)', fontSize: 11, fontFamily: 'var(--mono)', outline: 'none' }} />
                                          {comError && <div style={{ color: '#fca5a5', fontSize: 10, fontFamily: 'var(--mono)' }}>{comError}</div>}
                                          <div style={{ display: 'flex', gap: 6 }}>
                          ...
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                            ...
                            <div style={{ display: 'flex', gap: 6, flexShrink: 0, marginLeft: 8 }}>
                              ...
                              {misPermisos['tratamientos.eliminar'] && (
                                <button onClick={() => eliminarTratamiento(t.id)} style={{ padding: '4px 8px', borderRadius: 4, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer' }}>✕</button>
                              )}
                            </div>
                          </div>
                        </div>
                          ...
                          <>
                            {climaDatos.estacion && (
                              <div style={{ fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--muted)', marginBottom: 8, padding: '4px 0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                {climaDatos.fuente && (
                                  <span style={{ fontSize: 9, fontFamily: 'var(--mono)', padding: '2px 6px', borderRadius: 4, background: climaDatos.fuente === 'SIAR' ? 'rgba(61,220,110,0.1)' : 'rgba(77,184,255,0.1)', color: climaDatos.fuente === 'SIAR' ? 'var(--green)' : 'var(--blue)', textShadow: climaDatos.fuente === 'SIAR' ? 'var(--green-outline)' : 'none', border: `1px solid ${climaDatos.fuente === 'SIAR' ? 'rgba(61,220,110,0.3)' : 'rgba(77,184,255,0.3)'}` }}>
                                    {climaDatos.fuente}
                                  </span>
                                )}
                              </div>
                    ...
                    >
                      ...
                      <div style={{ height: 140, background: 'var(--surface2)', position: 'relative', overflow: 'hidden' }}>
                        ...
                        <button
                          ...
                          style={{ position: 'absolute', top: 8, right: 8, width: 32, height: 32, borderRadius: '50%', background: 'rgba(15, 26, 18, 1)', border: '1px solid var(--border)', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 15, backdropFilter: 'blur(4px)', transition: 'background 0.2s' }}
                          onMouseEnter={e => (e.currentTarget.style.background = 'rgba(61, 220, 110, 1)')}
                          onMouseLeave={e => (e.currentTarget.style.background = 'rgba(15, 26, 18, 1)')}
                        >
                          👁
                        </button>
                      </div>
        ...
        {pestana === 'tratamientos' && (
          <div style={{ flex: 1, height: '100%', overflow: 'auto', padding: isMobile ? 12 : 24, background: 'var(--bg)' }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
              ...
              {filtroCampanaTrat && (
                <button onClick={() => setFiltroCampanaTrat('')} style={{ padding: '6px 12px', borderRadius: 6, background: 'transparent', border: '1px solid rgba(251, 191, 36, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>✕ Quitar filtro de campaña</button>
              )}
              ...
              {(filtroTipo || filtroProducto || filtroCultivoTrat) && (
                <button onClick={() => { setFiltroTipo(''); setFiltroProducto(''); setFiltroCultivoTrat('') }} style={{ padding: '6px 12px', borderRadius: 6, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>✕ Limpiar</button>
              )}
            </div>
                    ...
                    <div key={t.id} style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 8, overflow: 'hidden' }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', cursor: 'pointer' }} onClick={() => setTratExpandido(expandido ? null : t.id)}>
                        ...
                        <div style={{ display: 'flex', gap: 6 }}>
                          ...
                          {misPermisos['tratamientos.eliminar'] && (
                            <button onClick={e => { e.stopPropagation(); eliminarTratamiento(t.id) }} style={{ padding: '5px 10px', borderRadius: 5, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>✕</button>
                          )}
                        </div>
                      </div>
                ...
                <div style={{ display: 'flex', gap: 8, marginBottom: 20, flexWrap: 'wrap' }}>
                  ...
                  {(filtroCampanaEstadistica || filtroFincaEstadistica) && (
                    <button onClick={() => { setFiltroCampanaEstadistica(''); setFiltroFincaEstadistica('') }}
                      style={{ padding: '7px 12px', borderRadius: 6, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>✕ Quitar filtros</button>
                  )}
                </div>
                            ...
                            <div key={key} style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 10, overflow: 'hidden' }}>
                              ...
                              {expandido && (
                                <div style={{ borderTop: '1px solid var(--border)', padding: '10px 14px', background: 'var(--surface2)' }}>
                                  ...
                                  {tieneDosisMax && !noComparable && (
                                    <div style={{ marginTop: 6, fontSize: 9, fontFamily: 'var(--mono)', color: 'var(--muted)' }}>
                                      Restante hasta máx: <span style={{ color: dosisPonderadaMostrar > (dosisMaximaValor as number) ? '#ff6b6b' : 'var(--green)', textShadow: dosisPonderadaMostrar > (dosisMaximaValor as number) ? 'none' : 'var(--green-outline)', fontWeight: 700 }}>
                    ...
                    {stock.map(s => {
                      ...
                      return (
                        <div key={s.id} style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1fr auto', gap: 8, padding: '10px 16px', borderBottom: '1px solid var(--border)', alignItems: 'center' }}>
                          ...
                          <div style={{ fontSize: 12, fontFamily: 'var(--mono)', fontWeight: 700, textAlign: 'right', color: existencias < 0 ? '#ff6b6b' : 'var(--green)', textShadow: existencias < 0 ? 'none' : 'var(--green-outline)' }}>
                            {existencias.toFixed(2)} {s.unidad}
                          </div>
                          {misPermisos['tratamientos.crear_editar'] && (
                            <button onClick={() => eliminarStockItem(s.id)} style={{ padding: '4px 8px', borderRadius: 4, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer', justifySelf: 'end' }}>✕</button>
                          )}
                        </div>
                      )
                    })}
          ...
          <div style={{ width: '100%', height: '100%', overflow: 'auto', padding: isMobile ? 12 : 24, background: 'var(--bg)' }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
              ...
              {(filtroFuncion || filtroContrato || filtroFincaPersonal) && (
                <button onClick={() => { setFiltroFuncion(''); setFiltroContrato(''); setFiltroFincaPersonal('') }} style={{ padding: '6px 12px', borderRadius: 6, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>Limpiar</button>
              )}
            </div>
                    ...
                    <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                      {esRecomendador(personalDetalle) && (
                        <button
                          ...
                          style={{ padding: '6px 12px', borderRadius: 6, background: personalDetalle.predeterminadoRecomendador ? 'rgba(77, 184, 255, 1)' : 'var(--surface)', border: `1px solid ${personalDetalle.predeterminadoRecomendador ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer', fontWeight: personalDetalle.predeterminadoRecomendador ? 700 : 400 }}
                        >
                      ...
                      {tratamientosDePersonal(personalDetalle.id, 'aplicado').map(t => {
                        ...
                        return (
                          <div key={t.id} style={{ background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 6, padding: '8px 12px', marginBottom: 6 }}>
                            <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginBottom: 3 }}>
                              <span style={{ fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--text)', fontWeight: 700 }}>{t.fecha}</span>
                              <span style={{ fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--green)', textShadow: 'var(--green-outline)', background: 'rgba(61,220,110,0.08)', border: '1px solid rgba(61,220,110,0.2)', borderRadius: 4, padding: '1px 6px' }}>{t.tipo}</span>
                            </div>
                      ...
                      >
                        <div style={{ display: 'flex', alignItems: 'flex-start', gap: 12, marginBottom: 10 }}>
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: 3, flexShrink: 0 }}>
                            ...
                            {p.predeterminadoAplicador && <span style={{ fontSize: 8, fontFamily: 'var(--mono)', color: 'var(--green)', textShadow: 'var(--green-outline)', background: 'rgba(61,220,110,0.08)', borderRadius: 3, padding: '1px 4px' }}>⭐ APL</span>}
                        ...
                        <div style={{ display: 'flex', gap: 6, marginBottom: 10, flexWrap: 'wrap' }}>
                          ...
                          {p.nroRopo && <span style={{ fontSize: 9, fontFamily: 'var(--mono)', color: 'var(--green)', textShadow: 'var(--green-outline)', background: 'rgba(61,220,110,0.06)', border: '1px solid rgba(61,220,110,0.15)', borderRadius: 4, padding: '2px 7px' }}>ROPO: {p.nroRopo}</span>}
                          {p.fincaId && fincas.find(f => f.id === p.fincaId) && (
                ...
                <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, width: '100%', maxWidth: 480, maxHeight: '90vh', overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
                    ...
                    <div>
                      ...
                      <select value={pContrato} onChange={e => setPContrato(e.target.value)} style={{ width: '100%', background: 'var(--surface2)', border: `1px solid ${!pContrato && pError ? '#ff6b6b' : 'var(--border)'}`, borderRadius: 6, padding: '9px 12px', color: 'var(--text)', fontSize: 13, fontFamily: 'var(--sans)', outline: 'none' }}>
                          ...
                          {fincas.map(f => {
                            ...
                            return (
                              <button key={f.id} type="button"
                                ...
                                style={{ padding: '6px 12px', borderRadius: 14, background: sel ? 'rgba(77, 184, 255, 1)' : 'var(--surface2)', border: `1px solid ${sel ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>
                                {f.nombre}
                              </button>
                            )
                          })}
          ...
          <div style={{ width: '100%', height: '100%', overflow: 'auto', padding: isMobile ? 12 : 24, background: 'var(--bg)' }}>
            ...
            <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
              ...
              {(filtroTipoEquipo || filtroFincaEquipo) && (
                <button onClick={() => { setFiltroTipoEquipo(''); setFiltroFincaEquipo('') }} style={{ padding: '6px 12px', borderRadius: 6, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>Limpiar</button>
              )}
            </div>
                ...
                <div style={{ padding: '12px 16px', borderBottom: '1px solid var(--border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--surface2)' }}>
                  ...
                  <div style={{ display: 'flex', gap: 8 }}>
                    ...
                    {misPermisos['maquinaria.eliminar'] && (
                      <button onClick={() => eliminarEquipo(equipoDetalle.id)} style={{ padding: '6px 12px', borderRadius: 6, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>Eliminar</button>
                    )}
                  </div>
                </div>
                <div style={{ padding: 16 }}>
                ...
                <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, width: '100%', maxWidth: 480, maxHeight: '90vh', overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
                    <div>
                      ...
                      <select value={eTipo} onChange={e => { setETipo(e.target.value); setESubtipo('') }} style={{ width: '100%', background: 'var(--surface2)', border: `1px solid ${!eTipo && eError ? '#ff6b6b' : 'var(--border)'}`, borderRadius: 6, padding: '9px 12px', color: 'var(--text)', fontSize: 13, fontFamily: 'var(--sans)', outline: 'none' }}>
                        <option value="" disabled>Selecciona tipo...</option>
                        {TIPOS_MAQUINARIA.map(t => <option key={t} value={t}>{t}</option>)}
                      </select>
                    </div>
                    {subtiposPorTipo(eTipo).length > 0 && (
                      <div>
                        ...
                        <select value={eSubtipo} onChange={e => setESubtipo(e.target.value)} style={{ width: '100%', background: 'var(--surface2)', border: `1px solid ${!eSubtipo && eError ? '#ff6b6b' : 'var(--border)'}`, borderRadius: 6, padding: '9px 12px', color: 'var(--text)', fontSize: 13, fontFamily: 'var(--sans)', outline: 'none' }}>
                    ...
                    <div>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16, flexWrap: 'wrap', gap: 10 }}>
                        ...
                        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                          ...
                          <button onClick={() => eliminarTarea(tareaSel.id)} style={{ padding: '8px 14px', borderRadius: 6, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>ELIMINAR</button>
                        </div>
                      </div>
                            ...
                            {misParcelas.filter(p => p.fincaId === tarFincaId).map(p => {
                              ...
                              return (
                                <button key={p.id} onClick={() => setTarParcelaIds(sel ? tarParcelaIds.filter(id => id !== p.id) : [...tarParcelaIds, p.id])}
                                  style={{ padding: '5px 10px', borderRadius: 14, background: sel ? 'rgba(61, 220, 110, 1)' : 'var(--surface)', border: `1px solid ${sel ? 'var(--green)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer' }}>
                          ...
                          {equipos.map(e => {
                            ...
                            return (
                              <button key={e.id} onClick={() => setTarEquipoIds(sel ? tarEquipoIds.filter(id => id !== e.id) : [...tarEquipoIds, e.id])}
                                style={{ padding: '5px 10px', borderRadius: 14, background: sel ? 'rgba(77, 184, 255, 1)' : 'var(--surface)', border: `1px solid ${sel ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer' }}>
                                {e.nombre}
                              </button>
                            )
                          })}
          ...
          return (
            <div key="cosechas" style={{ flex: 1, height: '100%', overflow: 'auto', padding: isMobile ? 12 : 24, background: 'var(--bg)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 10, marginBottom: 16 }}>
                ...
                {misPermisos['cosechas.crear_editar_eliminar'] && (
                  <button onClick={() => abrirNuevaCosecha()} style={{ padding: '7px 14px', borderRadius: 6, background: 'rgba(61, 220, 110, 1)', border: '1px solid var(--green)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 12, fontWeight: 700, cursor: 'pointer' }}>+ NUEVA COSECHA</button>
                )}
              </div>
          ...
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 2500, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
            <div style={{ background: 'var(--surface)', border: '1px solid var(--green)', borderRadius: 12, width: '100%', maxWidth: 420, padding: 24, maxHeight: '90vh', overflowY: 'auto' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
                  <div>
                    <label style={{ display: 'block', fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--muted)', marginBottom: 5, textTransform: 'uppercase' }}>1. Campaña <span style={{ color: '#ff6b6b' }}>*</span></label>
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--muted)', marginBottom: 5, textTransform: 'uppercase' }}>2. Finca <span style={{ color: '#ff6b6b' }}>*</span></label>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--muted)', marginBottom: 5, textTransform: 'uppercase' }}>3. Parcela <span style={{ color: '#ff6b6b' }}>*</span></label>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--muted)', marginBottom: 5, textTransform: 'uppercase' }}>Fecha de cosecha <span style={{ color: '#ff6b6b' }}>*</span></label>
                ...
                {cosError && <div style={{ color: '#fca5a5', fontSize: 11, fontFamily: 'var(--mono)' }}>{cosError}</div>}
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 3500, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
          <div style={{ background: 'var(--surface)', border: '1px solid var(--green)', borderRadius: 12, width: '100%', maxWidth: 460, maxHeight: '90vh', overflow: 'auto' }}>
            ...
            <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div>
                <label style={{ display: 'block', fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--muted)', marginBottom: 5, textTransform: 'uppercase' }}>
                  Fincas {fincas.length > 0 && <span style={{ color: '#ff6b6b', textTransform: 'none' }}>*</span>}
                </label>
                {fincas.length === 0 ? (
              ...
              {(() => {
                ...
                if (datasets.length === 0) {
                  return (
                    <div style={{ padding: '8px 12px', borderRadius: 6, background: 'rgba(77,184,255,0.08)', border: '1px solid rgba(77,184,255,0.25)', color: 'var(--blue)', fontSize: 11, fontFamily: 'var(--mono)' }}>
                ...
                if (!todasIguales) {
                  return (
                    <div style={{ padding: '8px 12px', borderRadius: 6, background: 'rgba(255,107,107,0.08)', border: '1px solid rgba(255,107,107,0.2)', color: '#fca5a5', fontSize: 11, fontFamily: 'var(--mono)', lineHeight: 1.5 }}>
                ...
                return (
                  <div style={{ padding: '8px 12px', borderRadius: 6, background: 'rgba(61,220,110,0.08)', border: '1px solid rgba(61,220,110,0.25)', color: 'var(--green)', textShadow: 'var(--green-outline)', fontSize: 11, fontFamily: 'var(--mono)' }}>
          ...
          <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, width: '100%', maxWidth: 480, maxHeight: '90vh', overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <div>
                ...
                <select value={tTipo} onChange={e => setTTipo(e.target.value)} style={{ width: '100%', background: 'var(--surface2)', border: `1px solid ${!tTipo && tError ? '#ff6b6b' : 'var(--border)'}`, borderRadius: 6, padding: '9px 12px', color: 'var(--text)', fontSize: 13, fontFamily: 'var(--sans)', outline: 'none' }}>
                  <option value="" disabled>Selecciona tipo...</option>
                  {TIPOS_TRATAMIENTO.map(t => <option key={t} value={t}>{t}</option>)}
                </select>
              </div>
              <div>
                ...
                {campanas.length === 0 ? (
                  ...
                  <select value={tCampanaId} onChange={e => setTCampanaId(e.target.value)} style={{ width: '100%', background: 'var(--surface2)', border: `1px solid ${!tCampanaId && tError ? '#ff6b6b' : 'var(--border)'}`, borderRadius: 6, padding: '9px 12px', color: 'var(--text)', fontSize: 13, fontFamily: 'var(--sans)', outline: 'none' }}>
                ...
                {fitoSeleccionado && (
                  <div style={{ marginTop: 6 }}>
                    ...
                    <div style={{ padding: '8px 10px', borderRadius: 6, background: fitoSeleccionado.eliminado ? 'rgba(255,107,107,0.04)' : 'rgba(61,220,110,0.06)', border: `1px solid ${fitoSeleccionado.eliminado ? 'rgba(255,107,107,0.2)' : 'rgba(61,220,110,0.2)'}`, fontSize: 10, fontFamily: 'var(--mono)' }}>
                      <div style={{ color: fitoSeleccionado.eliminado ? '#fca5a5' : 'var(--green)', textShadow: fitoSeleccionado.eliminado ? 'none' : 'var(--green-outline)', fontWeight: 700, marginBottom: 3 }}>
                      ...
                      {fitoSeleccionado.tiene_pdf && fitoSeleccionado.pdf_url && (
                        <button
                          ...
                          style={{ marginTop: 8, padding: '5px 12px', borderRadius: 5, background: 'rgba(77, 184, 255, 1)', border: '1px solid rgba(77, 184, 255, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: pdfCargando ? 'wait' : 'pointer', fontWeight: 700 }}
                        >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 16px', background: 'var(--surface)', borderBottom: '1px solid var(--border)', flexShrink: 0 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexShrink: 0 }}>
              <a
                ...
                style={{ padding: '6px 12px', borderRadius: 6, background: 'rgba(61,220,110,0.1)', border: '1px solid rgba(61,220,110,0.3)', color: 'var(--green)', textShadow: 'var(--green-outline)', fontFamily: 'var(--mono)', fontSize: 11, textDecoration: 'none', fontWeight: 700 }}
              >
                Descargar
              </a>
              <button
                onClick={() => { setFichaVisible(false); if (pdfBlobUrl) { URL.revokeObjectURL(pdfBlobUrl); setPdfBlobUrl(null) } }}
                style={{ padding: '6px 14px', borderRadius: 6, background: 'rgba(255, 107, 107, 1)', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 13, cursor: 'pointer', fontWeight: 700 }}
              >
                X
              </button>
            </div>
