          ...
          <div style={{ display: 'flex', width: '100%', height: '100%', position: 'relative' }}>
            ...
            <div style={{ flex: 1, overflowY: 'auto', padding: isMobile ? '0 16px 16px' : '0', flexDirection: 'column', gap: 14, display: panelAbierto || !isMobile ? 'flex' : 'none' }}>
              ...
              <section>
                ...
                <button onClick={() => { const next = !seleccionando; setSeleccionando(next); setMododibujo(false); setAnadiendoRecinto(false); if (isMobile && next) setPanelAbierto(false) }} style={{ width: '100%', padding: '10px', borderRadius: 8, background: seleccionando ? 'var(--green)' : 'var(--surface2)', border: `1px solid ${seleccionando ? 'var(--green)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 12, fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, transition: 'all 0.2s' }}>
                ...
                <button onClick={() => { setMododibujo(m => !m); setSeleccionando(false); setAnadiendoRecinto(false) }} style={{ width: '100%', padding: '9px', borderRadius: 8, background: mododibujo ? 'rgba(77, 184, 255, 1)' : 'var(--surface2)', border: `1px solid ${mododibujo ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}>
                ...
                {parcelaInfo && parcelaInfo.origen !== 'dibujado_mano' && !mododibujo && (
                  <button
                    ...
                    style={{ width: '100%', marginTop: 8, padding: '9px', borderRadius: 8, background: anadiendoRecinto ? 'rgba(77, 184, 255, 1)' : 'var(--surface2)', border: `1px solid ${anadiendoRecinto ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}
                  >
                ...
                {parcGeojson && (
                  <div style={{ display: 'flex', gap: 6, marginTop: 6 }}>
                    <button onClick={deseleccionar} style={{ flex: 1, padding: '7px', borderRadius: 6, background: 'transparent', border: '1px solid rgba(255, 107, 107, 1)', color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer' }}>
                      ✕ DESELECCIONAR
                    </button>
              ...
              {parcGeojson && (
                <>
                  ...
                  <section>
                    ...
                    <button onClick={buscarImagenes} disabled={cargando} style={{ width: '100%', padding: '8px', borderRadius: 6, background: 'transparent', border: '1px solid var(--blue)', color: 'var(--text)', fontSize: 11, fontFamily: 'var(--mono)', cursor: cargando ? 'wait' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                    ...
                    {productos.length > 0 && (
                      <div style={{ marginTop: 8 }}>
                        ...
                        <button onClick={verImagenRGB} disabled={cargando} style={{ width: '100%', marginTop: 8, padding: '9px', borderRadius: 6, background: modoVista === 'rgb' ? 'rgba(251, 191, 36, 1)' : 'var(--surface2)', border: `1px solid ${modoVista === 'rgb' ? 'var(--amber)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 600, cursor: cargando ? 'wait' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, transition: 'all 0.2s' }}>
              ...
              {productos.length > 0 && (
                <>
                  ...
                  <section>
                    ...
                    <button onClick={calcularZonasNDVI} disabled={cargando} style={{ width: '100%', padding: '11px', borderRadius: 8, background: cargando ? 'var(--surface2)' : 'var(--green)', border: 'none', color: 'var(--text)', fontFamily: 'var(--mono)', fontWeight: 700, fontSize: 13, cursor: cargando ? 'wait' : 'pointer', letterSpacing: '0.08em', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, transition: 'all 0.2s' }}>
              ...
              {zonasConSup.length > 0 && (
                <>
                  ...
                  <section>
                    ...
                    <button onClick={() => calcularProduccion(kgHaCalculado)} disabled={Object.keys(kgHaCalculado).length === 0} style={{ width: '100%', padding: '10px', borderRadius: 8, background: Object.keys(kgHaCalculado).length > 0 ? 'var(--green)' : 'var(--surface2)', border: 'none', color: 'var(--text)', fontFamily: 'var(--mono)', fontWeight: 700, fontSize: 12, cursor: Object.keys(kgHaCalculado).length > 0 ? 'pointer' : 'not-allowed', letterSpacing: '0.06em', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
                      🌾 CALCULAR PRODUCCIÓN
                    </button>
                  </section>
                </>
                    ...
                    {mapaActivo && (() => {
                      ...
                      return (
                        <div style={{ marginTop: 10 }}>
                          ...
                          <button onClick={toggleMapaMdt} style={{ width: '100%', marginTop: 8, padding: '8px', borderRadius: 6, background: mapaVisible ? 'rgba(77, 184, 255, 1)' : 'var(--surface2)', border: `1px solid ${mapaVisible ? 'var(--blue)' : 'var(--border)'}`, color: 'var(--text)', fontFamily: 'var(--mono)', fontSize: 10, cursor: 'pointer', fontWeight: 600 }}>
                    ...
                    <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
                      ...
                      {tarTipo === 'Alternativa no química' && (
                        <div style={{ padding: '10px 12px', borderRadius: 8, background: 'var(--surface2)', border: '1px solid var(--border)', display: 'flex', flexDirection: 'column', gap: 10 }}>
                          <div style={{ fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--green)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Datos para el Cuaderno de Campo (3.1 bis — solo con asesoramiento)</div>
                          <div>
                      ...
                      <div key={parte.key} style={{ background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 8, overflow: 'hidden' }}>
                        ...
                        {expandida && (
                          <div style={{ padding: '0 14px 14px', borderTop: '1px solid var(--border)' }}>
                            ...
                            <div style={{ fontSize: 10, fontFamily: 'var(--mono)', color: 'var(--green)', letterSpacing: '0.06em', marginBottom: 6, fontWeight: 700 }}>ENTRADAS ({parte.entradas.length})</div>
        ...
        {cosFormVisible && (
          <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 2500, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
            <div style={{ background: 'var(--surface)', border: '1px solid var(--green)', borderRadius: 12, width: '100%', maxWidth: 420, padding: 24, maxHeight: '90vh', overflowY: 'auto' }}>
              <div style={{ fontFamily: 'var(--mono)', fontSize: 13, fontWeight: 700, color: 'var(--green)', marginBottom: 16 }}>{cosEditar ? 'EDITAR COSECHA' : '+ NUEVA COSECHA'}</div>
          ...
          <div style={{ background: 'var(--surface)', border: '1px solid var(--green)', borderRadius: 12, width: '100%', maxWidth: 460, maxHeight: '90vh', overflow: 'auto' }}>
            ...
            <div style={{ padding: 20, display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              {(() => {
                ...
                return (
                  <div style={{ padding: '8px 12px', borderRadius: 6, background: 'rgba(61,220,110,0.08)', border: '1px solid rgba(61,220,110,0.25)', color: 'var(--green)', fontSize: 11, fontFamily: 'var(--mono)' }}>
