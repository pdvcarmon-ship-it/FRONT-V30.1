...
export const normalizarFechaExcel = (valor: any): string => {
  ...
  //    Usamos los componentes UTC: las fechas "solo fecha" de Excel se leen como
  //    medianoche UTC, y usar getters en hora local podría desplazar el día según
  //    el huso horario del navegador de quien importa.
