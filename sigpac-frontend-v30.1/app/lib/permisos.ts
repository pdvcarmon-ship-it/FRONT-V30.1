...
export type PermisoClave =
  ...
  | 'parcelas.ubicaciones.ver' | 'parcelas.ubicaciones.gestionar'
  | 'fincas.crear_editar' | 'fincas.eliminar'
  | 'tratamientos.ver' | 'tratamientos.crear_editar' | 'tratamientos.eliminar'
  | 'tratamientos.descargar_cuaderno'
  | 'riego.ver' | 'riego.crear_editar' | 'riego.eliminar'
  | 'maquinaria.ver' | 'maquinaria.crear_editar' | 'maquinaria.eliminar'
  | 'cosechas.ver' | 'cosechas.crear_editar_eliminar'
  | 'cosechas.comercializacion.ver' | 'cosechas.comercializacion.crear_editar_eliminar'
  | 'personal.ver' | 'personal.crear_editar' | 'personal.descargar_excel'
  | 'permisos.gestionar'
  | 'tareas.ver_todas' | 'tareas.crear_asignar'
  | 'abonado.ver' | 'abonado.crear_editar' | 'abonado.eliminar'
...
export const CATALOGO_PERMISOS: PermisoDescriptor[] = [
  ...
  { clave: 'parcelas.ubicaciones.ver', modulo: 'Parcelas', etiqueta: 'Ver ubicaciones (pozos, canales...)' },
  { clave: 'parcelas.ubicaciones.gestionar', modulo: 'Parcelas', etiqueta: 'Crear / editar / eliminar ubicaciones' },
  ...
  { clave: 'tratamientos.descargar_cuaderno', modulo: 'Tratamientos fitosanitarios', etiqueta: 'Descargar el Cuaderno de Campo' },
  ...
  { clave: 'cosechas.ver', modulo: 'Cosechas', etiqueta: 'Ver cosechas' },
  { clave: 'cosechas.crear_editar_eliminar', modulo: 'Cosechas', etiqueta: 'Crear / editar / eliminar cosechas' },
  { clave: 'cosechas.comercializacion.ver', modulo: 'Cosechas', etiqueta: 'Ver comercialización' },
  { clave: 'cosechas.comercializacion.crear_editar_eliminar', modulo: 'Cosechas', etiqueta: 'Crear / editar / eliminar comercialización' },
  ...
  { clave: 'personal.descargar_excel', modulo: 'Personal', etiqueta: 'Descargar Excel de horario (personal)' },

  { clave: 'permisos.gestionar', modulo: 'Permisos', etiqueta: 'Gestionar permisos de otros trabajadores' },

  { clave: 'abonado.ver', modulo: 'Plan de abonado', etiqueta: 'Ver plan de abonado' },
  { clave: 'abonado.crear_editar', modulo: 'Plan de abonado', etiqueta: 'Crear / editar análisis, necesidades, abonos y planes' },
  { clave: 'abonado.eliminar', modulo: 'Plan de abonado', etiqueta: 'Eliminar análisis, necesidades, abonos y planes' },
...
export const PLANTILLAS_ROL: Record<string, Record<PermisoClave, boolean>> = {
  ...
  tecnico: {
    ...
    'parcelas.ubicaciones.ver': true,
    'tratamientos.ver': true, 'tratamientos.crear_editar': true, 'tratamientos.descargar_cuaderno': true,
    'riego.crear_editar': true,
    'cosechas.ver': true, 'cosechas.comercializacion.ver': true,
  },
  peon: {
    ...todosA(false),
    'parcelas.ver': true, 'riego.ver': true, 'maquinaria.ver': true,
