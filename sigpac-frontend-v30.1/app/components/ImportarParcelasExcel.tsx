    ...
    <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.7)', zIndex: 2000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, width: '100%', maxWidth: 780, maxHeight: '90vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ flex: 1, overflow: 'auto', padding: 20 }}>
          ...
          {errorGeneral && (
            <div style={{ padding: '10px 14px', borderRadius: 8, background: 'rgba(110, 36, 23,0.1)', border: '1px solid rgba(110, 36, 23,0.35)', color: '#6E2417', fontFamily: 'var(--mono)', fontSize: 12, marginBottom: 16 }}>
              {errorGeneral}
            </div>
          )}
          ...
          {(fase === 'preview' || fase === 'importando') && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              {parcelasOk.map((p, i) => (
                <div key={i} style={{ padding: '10px 14px', borderRadius: 8, background: 'var(--green-dim)', border: '1px solid rgba(31, 74, 40,0.2)', fontSize: 12 }}>
              ...
              {errores.length > 0 && (
                <div>
                  <div style={{ fontFamily: 'var(--mono)', fontSize: 11, color: '#6E2417', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: 8 }}>
                    Filas con error ({errores.length}) — no se importarán
                  </div>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                    {errores.map((e, i) => (
                      <div key={i} style={{ fontSize: 11, color: '#6E2417', fontFamily: 'var(--mono)' }}>
