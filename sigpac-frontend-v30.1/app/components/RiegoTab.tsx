                    ...
                    <div key={sector.id} style={{ background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: 8, padding: '10px 12px', marginBottom: 10 }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 6, flexWrap: 'wrap', gap: 8 }}>
                        ...
                        <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                          ...
                          <button onClick={() => abrirCalculoRiego(sector.id)} style={{ padding: '5px 10px', borderRadius: 6, background: 'rgba(61,220,110,0.1)', border: '1px solid var(--green)', color: 'var(--green)', textShadow: 'var(--green-outline)', fontFamily: 'var(--mono)', fontSize: 10, fontWeight: 700, cursor: 'pointer' }}>📊 Calcular necesidades</button>
                          */}
                          {misPermisos['riego.crear_editar'] && (
                      ...
                      {calculandoRiegoSectorId === sector.id && (
                        <div style={{ marginTop: 10, padding: 12, background: 'var(--surface)', border: '1px solid var(--green)', borderRadius: 8 }}>
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 }}>
                            <span style={{ fontFamily: 'var(--mono)', fontSize: 11, fontWeight: 700, color: 'var(--green)', textShadow: 'var(--green-outline)' }}>PREDICCIÓN DE RIEGO</span>
                                  ...
                                  <tbody>
                                    {predResultado.tabla.map(fila => (
                                      <tr key={fila.fecha} style={{ borderBottom: '1px solid var(--border)' }}>
                                        ...
                                        <td style={{ padding: '5px 8px', color: 'var(--green)', textShadow: 'var(--green-outline)', fontWeight: 700 }}>{fila.necesidadM3Ha !== null ? fila.necesidadM3Ha.toFixed(1) : '—'}</td>
                                      </tr>
                                    ))}
                                  </tbody>
                                </table>
          ...
          <div style={{ marginBottom: 8 }}>
            ...
            {secModo === 'dibujado' && (
              <div style={{ marginTop: 8 }}>
                {secGeojsonDibujado ? (
                  <div>
                    <div style={{ padding: '8px 10px', borderRadius: 6, background: 'rgba(61,220,110,0.1)', border: '1px solid var(--green)', color: 'var(--green)', textShadow: 'var(--green-outline)', fontFamily: 'var(--mono)', fontSize: 11, marginBottom: 6 }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                    <button onClick={() => seleccionarPieza({ geojson: restanteGeojson, supHa: restanteSupHa })} style={{ width: '100%', padding: '8px', borderRadius: 6, background: 'rgba(61,220,110,0.1)', border: '1px solid var(--green)', color: 'var(--green)', textShadow: 'var(--green-outline)', fontFamily: 'var(--mono)', fontSize: 11, cursor: 'pointer' }}>
