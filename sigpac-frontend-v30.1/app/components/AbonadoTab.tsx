...
interface ParcelaLite { id: string; nombre: string; cultivo: string; fincaId?: string; referenciaSigpac?: string; supHa?: number; recintos?: { referencia: string; supHa: number }[] }
