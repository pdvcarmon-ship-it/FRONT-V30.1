...
export default function AbonadoTab({ session, fincas, misParcelas, campanas, historicoCultivos, equipos, personal, isMobile, misPermisos }: Props) {
  ...
  const sueloInicialNorm: Nutrientes & { ph?: number; ce?: number } = analisisVigente
    ? { ...normalizarPK(normalizarUnidades(analisisVigente.nutrientes, analisisVigente.unidades, OPCIONES_CANTIDAD, 'kg_ha'), analisisVigente.pBase, analisisVigente.kBase), ph: analisisVigente.ph, ce: analisisVigente.ce }
    : { ...NUTRIENTES_VACIO }
