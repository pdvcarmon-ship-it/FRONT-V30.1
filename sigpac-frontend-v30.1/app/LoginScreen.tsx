    ...
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', background: 'var(--bg)' }}>
      <div style={{ width: '100%', maxWidth: 380, padding: 32, background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12 }}>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          {error && <div style={{ padding: '8px 12px', borderRadius: 6, background: 'rgba(110, 36, 23,0.08)', border: '1px solid rgba(110, 36, 23,0.2)', color: '#6E2417', fontSize: 12, fontFamily: 'var(--mono)' }}>⚠ {error}</div>}
          {info && <div style={{ padding: '8px 12px', borderRadius: 6, background: 'rgba(31, 74, 40,0.08)', border: '1px solid rgba(31, 74, 40,0.2)', color: 'var(--green)', fontSize: 12, fontFamily: 'var(--mono)' }}>✓ {info}</div>}
